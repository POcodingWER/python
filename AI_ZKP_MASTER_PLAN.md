...
- [x] **PyTorch 기본** ✅
  ...
  - [x] Tensor 연산, autograd 이해 ✅
  - [x] 간단한 신경망 구현 (from scratch) ✅
  - [x] 손실함수, 옵티마이저 사용법 ✅
...
- [x] **딥러닝 기초** ✅
  ...
  - [x] 역전파 알고리즘 이해 ✅
  - [x] CNN 개념과 구현 (이미지 분류) ✅
  - [x] RNN/LSTM 개념과 구현 (시계열) ✅

- [x] **실전 프로젝트** ✅
  - [x] CIFAR-10 이미지 분류 모델 ✅
  - [x] 모델 성능 최적화 (하이퍼파라미터 튜닝) ✅
...
- [x] **EZKL 라이브러리** ✅
  ...
  - [x] EZKL 설치 및 설정 ✅
  - [x] 간단한 ML 모델을 ZK 회로로 변환 ✅
  - [x] 추론 결과의 ZKP 생성 ✅

- [x] **ZKML 한계 파악** ✅
  - [x] Linear Regression → ZKML 성공 ✅
  - [x] MLP (Iris) → ZKML 성공 ✅
  - [x] Tiny MLP (MNIST) → ZKML 성공 ✅
  - [x] RNN/CNN → ZKML 불가능 확인 ✅
  - [x] PyTorch 1.13 환경 구축 ✅
  - [x] ZKML 상용화 한계 명확히 이해 ✅
...
- [x] 간단한 AI 모델 + ZKP 증명 생성 가능 ✅
- [ ] Circom으로 기본 회로 작성 능력 (Month 4 예정)
- [x] Python/JavaScript 생태계 숙련 ✅

### 6개월 후 (진행 중 🚀)

- [x] ZKML 기초 프로젝트 완성 ✅
- [x] Linear/MLP 모델 ZKML 변환 성공 ✅
- [x] **ZKML 한계 파악 및 문서화** ✅ (중요!)
- [ ] 기술 블로그 포스팅 (예정)
...
**시작일**: 2025년 1월  
**목표 완료일**: 2025년 12월  
**현재 진행률**: Phase 1 완료 ✅, Month 3 완료 ✅, Month 5-6 완료 ✅ (약 50%)  
**핵심 성과**: PyTorch/딥러닝 마스터, ZKML 기초 완성, **ZKML 현실적 한계 파악** ✅  
